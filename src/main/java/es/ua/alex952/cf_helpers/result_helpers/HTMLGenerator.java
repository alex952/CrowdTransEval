...
public class HTMLGenerator {
	...
	/**
	 * Generates charts representing the Kappa average for
	 * each service (fluency and adequacy).
	 * 
	...
	/**
	 * Generates a table for each service containing the
	 * info about factor Kappa calculated every pair of raters.
	 * 
	 * @param raters Hashmap of pairs of raters
	 */
	...
	/*public String generateHTML(HashMap<String, HashMap<String, KappaRaters>> raters) {
		this.generateSurrondings();
		return this.htmlGenerated;
	}*/

	/**
	 * Returns the html generated by the above procedures
	 * along with the headers and extra tags for a complete
	 * html output.
	 * 
